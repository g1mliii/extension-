-- Quick fix for array_agg DISTINCT syntax error in auto_generate_content_type_rules function
-- This fixes the PostgreSQL error: "ORDER BY expressions must appear in argument list"
...
BEGIN
    ...
    LOOP
        -- [Rest of the function logic remains the same - just fixing the syntax error]
