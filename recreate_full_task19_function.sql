-- Recreate the FULL Task 19 content rule generation function
-- This is the complete, comprehensive version from the migration
...
-- Test the function
SELECT 'Testing FULL Task 19 content rule generation:' as info;
